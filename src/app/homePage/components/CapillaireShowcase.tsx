...
const MOCK_PRODUCTS: Product[] = [
  {
    id: 301,
    name: "Shampooing Ducray Anaphase",
    brand: "Ducray",
    slug: "shampooing-ducray",
    description: "Complément antichute qui redonne volume and vigueur aux cheveux.",
  ...
  {
    id: 302,
    name: "Masque Capillaire Klorane",
    brand: "Klorane",
    slug: "masque-capillaire-klorane",
    description: "Nourrit intensément et répare les cheveux très secs ou abîmés.",
  ...
  {
    id: 303,
    name: "Soin Cheveux Furterer",
    brand: "René Furterer",
    slug: "soin-cheveux-furterer",
    description: "Soin expert pour sublimer la chevelure et cuir chevelu.",
  ...
  {
    id: 304,
    name: "Après-Shampooing PHYTO",
    brand: "Phyto",
    slug: "apres-shampooing-phyto",
    description: "Démêle instantanément et apporte une brillance miroir.",
  ...
  {
    id: 305,
    name: "Sérum Fortifiant Vichy Dercos",
    brand: "Vichy",
    slug: "serum-fortifiant-vichy",
    description: "Agit sur les signes de la chute pour une chevelure plus dense.",
  ...
  {
    id: 306,
    name: "Lotion Capillaire SVR",
    brand: "SVR",
    slug: "lotion-capillaire-svr",
    description: "Apaise le cuir chevelu sujet aux démangeaisons.",
  ...
  {
    id: 307,
    name: "Shampooing Doux Avène",
    brand: "Avène",
    slug: "shampooing-doux-avene",
    description: "Nettoie en respectant l'équilibre du cuir chevelu sensible.",
  ...
  {
    id: 308,
    name: "Soin Sublimateur La Roche-Posay",
    brand: "La Roche-Posay",
    slug: "soin-capillaire-roche-posay",
    description: "Apporte souplesse et éclat aux cheveux ternes.",
  ...
  return (
    <section className="relative overflow-hidden bg-white py-20">
            ...
            >
              {products.map((product, index) => {
                ...
                return (
                  <Link
                    key={product.id}
                    href={`/products?category=Capillaire`}
      ...
      <div className='relative w-full h-[800px] mt-20'>
        <Image src="/img/ACTIVES_1.webp" alt="Biocol" fill className='object-cover' />
      </div>
      <style>{`
