...
const MOCK_PRODUCTS: Product[] = [
  {
    id: 401,
    name: "URGO GEL APHTES JUNIOR 8ML",
    brand: "URGO",
    slug: "urgo-gel-aphtes-junior-8ml",
    description: "URGO GEL APHTES JUNIOR 8ML",
    original_price: 150.00,
    discounted_price: 130.00,
    stock_quantity: 40,
    image_url: "img/products/3664492019017-300x307.jpg.webp",
  ...
  {
    id: 402,
    name: "NATURALIUM SHOWER GEL GINGER TONING 500ML",
    brand: "NATURALIUM",
    slug: "naturalium-shower-gel-ginger-toning-500ml",
    description: "NATURALIUM SHOWER GEL GINGER TONING 500ML",
    original_price: 180.00,
    discounted_price: null,
    stock_quantity: 50,
    image_url: "img/products/C-300x308.png.webp",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    category_id: CATEGORY_ID,
    subcategory_id: null,
  ...
  {
    id: 403,
    name: "CATTIER GYNEA SOIN DOUCEUR TOILETTE INTIME 200 ML",
    brand: "CATTIER",
    slug: "cattier-gynea-soin-douceur-toilette-intime-200-ml",
    description: "CATTIER GYNEA SOIN DOUCEUR TOILETTE INTIME 200 ML",
    original_price: 145.00,
    discounted_price: 125.00,
    stock_quantity: 30,
    image_url: "img/products/3283950910255-300x346.jpg.webp",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    category_id: CATEGORY_ID,
    subcategory_id: null,
  ...
  {
    id: 404,
    name: "ROGE CAVAILLES ECO RECHARGE SOIN TOILETTE INTIME EXTRA DOUX 500ML",
    brand: "ROGE CAVAILLES",
    slug: "roge-cavailles-eco-recharge-soin-toilette-intime-extra-doux-500ml",
    description: "ROGE CAVAILLES ECO RECHARGE SOIN TOILETTE INTIME EXTRA DOUX 500ML",
    original_price: 90.00,
    discounted_price: null,
    stock_quantity: 60,
    image_url: "img/products/3596490007171-300x346.jpg.webp",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    category_id: CATEGORY_ID,
    subcategory_id: null,
  ...
  {
    id: 405,
    name: "PURESSENTIEL GEL INTIME DOUCEUR 250ML",
    brand: "PURESSENTIEL",
    slug: "puressentiel-gel-intime-douceur-250ml",
    description: "PURESSENTIEL GEL INTIME DOUCEUR 250ML",
    original_price: 165.00,
    discounted_price: 140.00,
    stock_quantity: 25,
    image_url: "img/products/3401351476013-300x311.jpg",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    category_id: CATEGORY_ID,
    subcategory_id: null,
  ...
  {
    id: 406,
    name: "URIAGE GYN 8 100ML",
    brand: "URIAGE",
    slug: "uriage-gyn-8-100ml",
    description: "URIAGE GYN 8 100ML",
    original_price: 195.00,
    discounted_price: 170.00,
    stock_quantity: 20,
    image_url: "img/products/3661434001062-300x314.jpg",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    category_id: CATEGORY_ID,
    subcategory_id: null,
  ...
  {
    id: 407,
    name: "ROGE CAVAILLES SOIN TOILETTE INTIME AVEC ANTI BACTERIEN 250ML NEW",
    brand: "ROGE CAVAILLES",
    slug: "roge-cavailles-soin-toilette-intime-avec-anti-bacterien-250ml-new",
    description: "ROGE CAVAILLES SOIN TOILETTE INTIME AVEC ANTI BACTERIEN 250ML NEW",
    original_price: 135.00,
    discounted_price: null,
    stock_quantity: 35,
    image_url: "img/products/3596490007072-300x327.jpg",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    category_id: CATEGORY_ID,
    subcategory_id: null,
  ...
  {
    id: 408,
    name: "CAMOMILLA BLU NETTOYANT INTIME 5.5 DAILY USE 300ML",
    brand: "CAMOMILLA BLU",
    slug: "camomilla-blu-nettoyant-intime-5.5-daily-use-300ml",
    description: "CAMOMILLA BLU NETTOYANT INTIME 5.5 DAILY USE 300ML",
    original_price: 115.00,
    discounted_price: 95.00,
    stock_quantity: 15,
    image_url: "img/products/CAMOMILLA-BLU-NETTOYANT-INTIME-5.5-DAILY-USE-300ML-300x300.jpg",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    category_id: CATEGORY_ID,
    subcategory_id: null,
            ...
            >
              ...
              >
                ...
                <span
                  ...
                  style={{ fontFamily: "'Jost', sans-serif" }}
                >
                  Voir tous les<br />soins hygiéniques
                </span>
              </Link>
            </div>
...
export default HygieneShowcase;