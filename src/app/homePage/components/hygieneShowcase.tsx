...
const MOCK_PRODUCTS: Product[] = [
  {
    id: 401,
    name: "Gel Douche Bioderma Atoderm",
    brand: "Bioderma",
    slug: "gel-douche-bioderma",
    description: "Nettoyant ultra-nourrissant pour peaux sensibles sèches à très sèches.",
    original_price: 150.00,
    discounted_price: 130.00,
    stock_quantity: 40,
    image_url: "img/products/24.jpg",
  ...
  {
    id: 402,
    name: "Soin Lavant La Roche-Posay Lipikar",
    brand: "La Roche-Posay",
    slug: "soin-lavant-roche-posay",
    description: "Nettoie en douceur et apaise immédiatement les sensations de tiraillement.",
    original_price: 180.00,
    discounted_price: null,
    stock_quantity: 50,
    image_url: "img/products/25.jpg",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    category_id: CATEGORY_ID,
    subcategory_id: null,
  ...
  {
    id: 403,
    name: "Nettoyant Doux Cetaphil",
    brand: "Cetaphil",
    slug: "nettoyant-cetaphil-hygiene",
    description: "Une formule douce qui n'altère pas le film hydrolipidique de la peau.",
    original_price: 145.00,
    discounted_price: 125.00,
    stock_quantity: 30,
    image_url: "img/products/26.jpg",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    category_id: CATEGORY_ID,
    subcategory_id: null,
  ...
  {
    id: 404,
    name: "Eau Thermale Avène Spray",
    brand: "Avène",
    slug: "eau-thermale-avene-spray",
    description: "Le geste essentiel pour apaiser and rafraîchir la peau à tout moment.",
    original_price: 90.00,
    discounted_price: null,
    stock_quantity: 60,
    image_url: "img/products/27.jpg",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    category_id: CATEGORY_ID,
    subcategory_id: null,
  ...
  {
    id: 405,
    name: "Gel Nettoyant CeraVe",
    brand: "CeraVe",
    slug: "gel-nettoyant-cerave",
    description: "Nettoie, élimine l'excès de sébum et restaure la barrière cutanée.",
  ...
  {
    id: 406,
    name: "Huile de Lavante SVR Topialyse",
    brand: "SVR",
    slug: "huile-lavante-svr",
    description: "Soin lavant anti-irritations, 24h d'hydratation et confort immédiat.",
    original_price: 195.00,
    discounted_price: 170.00,
    stock_quantity: 20,
    image_url: "img/products/29.jpg",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    category_id: CATEGORY_ID,
    subcategory_id: null,
  ...
  {
    id: 407,
    name: "Soin Hygiène Uriage Gyn-Phy",
    brand: "Uriage",
    slug: "soin-hygiene-uriage",
    description: "Nettoie en douceur sans dessécher et préserve l'équilibre.",
    original_price: 135.00,
    discounted_price: null,
    stock_quantity: 35,
    image_url: "img/products/30.jpg",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    category_id: CATEGORY_ID,
    subcategory_id: null,
  ...
  {
    id: 408,
    name: "Gel Douche Vichy Magno",
    brand: "Vichy",
    slug: "gel-douche-vichy",
    description: "Un moment de détente pure avec une mousse onctueuse and parfumée.",
