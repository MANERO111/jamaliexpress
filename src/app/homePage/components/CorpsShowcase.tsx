...
const MOCK_PRODUCTS: Product[] = [
  {
    id: 201,
    name: "Lait Corps Hydratant Cerave",
    brand: "CeraVe",
    slug: "lait-corps-hydratant-cerave",
  ...
  {
    id: 202,
    name: "Huile de Douche Bioderma Atoderm",
    brand: "Bioderma",
    slug: "huile-douche-bioderma",
  ...
  {
    id: 203,
    name: "Gel Douche La Roche-Posay Lipikar",
    brand: "La Roche-Posay",
    slug: "gel-douche-roche-posay",
  ...
  {
    id: 204,
    name: "Crème Mains Hydratante Neutrogena",
    brand: "Neutrogena",
    slug: "creme-mains-neutrogena",
    description: "Soulage immédiatement et hydrate durablement les mains les plus sèches.",
  ...
  {
    id: 205,
    name: "Lait Corps Nourrissant Nuxe",
    brand: "Nuxe",
    slug: "lait-corps-nuxe",
  ...
  {
    id: 206,
    name: "Baume Relipidant SVR Topialyse",
    brand: "SVR",
    slug: "baume-relipidant-svr",
    description: "Soin anti-irritations, sécheresse et grattage sévères.",
  ...
  {
    id: 207,
    name: "Lait Hydratant Corps Uriage",
    brand: "Uriage",
    slug: "lait-hydratant-uriage",
    description: "Apporte une hydratation intense et un confort immédiat.",
  ...
  {
    id: 208,
    name: "Soin Corps Vichy Ideal Body",
    brand: "Vichy",
    slug: "soin-corps-vichy",
    description: "Une peau plus ferme, plus lisse et plus lumineuse.",
    original_price: 320.00,
    discounted_price: 285.00,
    stock_quantity: 10,
    image_url: "img/products/15.jpg",
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
    category_id: CATEGORY_ID,
    subcategory_id: null,
