    ...
    <div className="flex gap-4 px-6 md:px-10 pb-4">
      {Array.from({ length: 4 }).map((_, i) => (
        <div key={i} className="flex-shrink-0 w-[220px] animate-pulse">
          <div className="h-[260px] bg-gray-100 rounded-sm" />
          <div className="p-3 space-y-2">
            <div className="h-2 w-14 bg-gray-100 rounded" />
            <div className="h-4 w-36 bg-gray-100 rounded" />
            <div className="h-3 w-20 bg-gray-100 rounded" />
            <div className="h-9 bg-gray-100 rounded-sm mt-3" />
          </div>
        </div>
      ))}
    </div>
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 px-6 md:px-10 mb-12">
          ...
          <div>
            ...
            >
              {loading
                ? 'Chargement…'
                : `${products.length} produits pour sublimer votre corps`}
            </p>
          </div>
