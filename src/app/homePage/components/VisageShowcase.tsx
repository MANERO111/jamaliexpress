...
const MOCK_PRODUCTS: Product[] = [
  {
    id: 101,
    name: "Lait Démaquillant Doux ",
    brand: "Soin Essentiel",
    slug: "lait-demaquillant-doux",
    description: "Nettoie en douceur et apaise les peaux sensibles.",
  ...
  },
  {
    ...
    description: "Hydratation continue et protection de la barrière cutanée.",
  ...
  {
    id: 103,
    name: "Soin Visage La Roche-Posay",
    brand: "La Roche-Posay",
    slug: "soin-visage-roche-posay",
    description: "Soin apaisant pour peaux intolérantes ou allergiques.",
  ...
  },
  {
    ...
    brand: "Cetaphil",
    slug: "nettoyant-doux-cetaphil",
    description: "Nettoie sans irriter, idéal pour un usage quotidien.",
  ...
  {
    id: 105,
    name: "Crème Hydratante Vichy",
    brand: "Vichy",
    slug: "creme-hydratante-vichy",
    description: "Renforce la peau contre les agressions extérieures.",
  ...
  {
    id: 106,
    name: "Sérum Anti-Âge SVR",
    brand: "SVR",
    slug: "serum-anti-age-svr",
    description: "Lisse les rides et raffermit la peau visiblement.",
  ...
  },
  {
    ...
    brand: "Avène",
    slug: "eau-thermale-avene",
    description: "Apaise, diminue les irritations et rafraîchit.",
  ...
  {
    id: 108,
    name: "Soin Bioderma Atoderm",
    brand: "Bioderma",
    slug: "soin-bioderma-atoderm",
  ...
  return (
    <section className="relative overflow-hidden bg-white py-20">
      ...
      <div className='relative w-full h-[600px] mt-20'>
        <img src="/img/para8.jpg" alt="Biocol" className='object-cover' />
      </div>
      <style>{`
