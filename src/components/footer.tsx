...
const info = [
  ...
  { label: 'Contactez-nous',              href: '/aboutUs' },
...
const socials = [
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/jamali_express/',
    icon: (
  ...
  {
    label: 'Facebook',
    href: 'https://web.facebook.com/para.jamaliexpress?locale=fr_FR',
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
